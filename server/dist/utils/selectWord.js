function selectWord(wordList, desiredLength, uniqueLettersOnly = false) {
    ...
    const filteredWords = wordList.filter((word) => {
        ...
        return (!uniqueLettersOnly || new Set(cleanedWord).size === cleanedWord.length //.size give the number of unique "characters / letters" depending on the cleanedword.length.
        );
    });
...
//# sourceMappingURL=selectWord.js.map